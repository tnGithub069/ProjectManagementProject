...
def main(urlID,projectName,projectComment,projectNaiyo,projectCrtUserID):
    #--戻り値用の変数宣言------------------------------------------------------------------------------
    errflg = "0"
    list_msgInfo = []
    json_shitsmnInfo = {}
    ...
    try:
        ...
        #--(2.2.)クエリとパラメータを定義
        sql = "INSERT INTO T100_PROJECT VALUES (%s,%s,%s,%s,%s,%s,%s,%s,current_timestamp(6),%s,%s,current_timestamp(6),%s);"
        args = (newID_S100,urlID,projectName,projectComment,projectNaiyo,projectCrtUserID,SERVICE_ID,projectCrtUserID,SERVICE_ID,projectCrtUserID,"0",)
        #クエリを実行し、結果を取得
        #T100
        ...
        #アクセスパス表示
        msgAccess = "アクセスパスを控えてください： "+"projectmanagementapp/project/" + urlID + "/top/"
        msgID = "S0000"
